...
- **Entries sent to the LLM must be de-identified first** — no student name, no staff name, no student ID. Do not "simplify" this by passing full records through for convenience.
